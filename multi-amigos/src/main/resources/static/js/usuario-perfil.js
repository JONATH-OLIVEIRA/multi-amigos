                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputTelefone" value="${this.escapeHtml(dados.telefone || '')}">
                                </div>

                                <div class="col-12 mb-3">
                                    <label class="form-label"><strong>Nova Senha</strong> <small class="text-muted">(deixe em branco)</small></label>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-grid gap-2 mt-2">
                                    <button class="btn btn-outline-success" id="btnGerarLink">
                                        <i class="bi bi-link-45deg"></i> Gerar Link de Convite
                                    </button>
                                    <button class="btn btn-outline-warning" id="btnVerRede">
                                        <i class="bi bi-diagram-3"></i> Ver Minha Rede
                                    </button>
                                    <button class="btn btn-outline-danger" id="btnDesativar">
            ...
            html += `
                <div class="card">
                    <div class="card-header bg-warning text-white">
                        <h5 class="mb-0"><i class="bi bi-people"></i> Minha Rede (${hierarquia.length})</h5>
                    </div>
                    <div class="card-body">
            ...
            hierarquia.forEach(filho => {
                html += `
                    <tr>
                        ...
                        <td>${filho.ativo ? '<span class="badge bg-success">Ativo</span>' : '<span class="badge bg-secondary">Inativo</span>'}</td>
